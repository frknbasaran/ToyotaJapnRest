...
function check(date,type,day,today,month,thisMonth){
    ...
    $.ajax({
        ...
        success: function(data){
            if(data.result==1){
                if((thisMonth>month) || (today>day && thisMonth>=month)){
                    $('.'+day).after('<tr class="passive"><td>'+reservation_types[type]+'</td><td>&nbsp;</td><td><input checked disabled class="setRestaurant" type="checkbox" data-type="'+type+'" data-date="'+date+'"></td><td></td></tr>');
                }else{
                    $('.'+day).after('<tr><td>'+reservation_types[type]+'</td><td>&nbsp;</td><td><input checked class="setRestaurant" type="checkbox" data-type="'+type+'" data-date="'+date+'"></td><td></td></tr>');
                }
            }
            else{
                if((thisMonth>month) || (today>day && thisMonth>=month)){
                    $('.'+day).after('<tr class="passive"><td>'+reservation_types[type]+'</td><td>&nbsp;</td><td><input disabled class="setRestaurant" type="checkbox" data-type="'+type+'" data-date="'+date+'"></td><td></td></tr>');
                }else{
                    $('.'+day).after('<tr><td>'+reservation_types[type]+'</td><td>&nbsp;</td><td><input class="setRestaurant" type="checkbox" data-type="'+type+'" data-date="'+date+'"></td><td></td></tr>');
                }
...
cal_days_labels = ['Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt', 'Pzr'];
